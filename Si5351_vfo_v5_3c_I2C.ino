/*
 ...
 v5-3b       14 December 2021  Newer batches of Si5351's default to spread spectrum if
                               not set to disable. This version includes code to disable
                               the spread spectrum mode.
 v5-3b-i2c   15 December 2021  i2C Display Version  

 v5-3b-i2c   31 July 2023     Included capability to subract CLK2 from CLK1 within the
 ...
 A4/D18 Si5351 SDA  i2c Display Connection
 A5/D19 Si5351 SCL  i2c Display Connection 
...
#include <LiquidCrystal_I2C.h>    // <Wire.h> Included Already
#include <string.h>
#include <ctype.h>
