/*
  ...
  v5-3b  14 December 2021 Newer baatches of Si5351's default to spread spectrum if
                         not set to disable. This version includes code to disable
                         the spread spectrum mode.
  v5-3d  2 April 2022     Included capability to subract CLK2 from CLK1 within the
                         'Freq_array' configuration.
  ...
  bug with Arduino 1.6.11 and testing revision v5_2. Also thanks to Ed Vink, PA0ECV,
  for adding the capability to subract CLK2 from CLK within the 'Freq_array'
  configuration.
...
/*
  ...
  3 = Subtract CLK2 from CLK1  CLK 2 must be HIGHER in frequency
...
void setfreq()
{
  ...
  switch (Freq_array [band] [2])     // Get math function from frequency array
  {
    case 1:  // If math function is 1 then add Freq_1 and Freq_2 for display
      ...
      break;
    case 2:  // If math function is 2 then subtract Freq_1 from Freq_2, for the correct display Freq_1 must be LOWER than Freq_2!
